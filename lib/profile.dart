...
import 'package:scholarship/login.dart';
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      return Column(children: [
                        itemProfile('อีเมลล์', data[0]['uemail'].toString(),
                            CupertinoIcons.mail),
                        SizedBox(
                          height: 15,
                        ),
                        itemProfile(
                            'ชื่อ',
                            data[0]['ufname'].toString() +
                                spac +
                                data[0]['ulname'].toString(),
                        ...
                        itemProfile(
                            'การศึกษา',
                            data[0]['uclass'].toString() +
                                '   ' +
                                data[0]['ufaculty'].toString() +
                                '  สาขา ' +
                                data[0]['ubranch'].toString(),
                            CupertinoIcons.book),
                        SizedBox(
                          height: 15,
                        ),
                        itemProfile('ผลการศึกษา', data[0]['ugpa'].toString(),
                        ...
                        itemProfile(
                            'ผลการสอบ',
                            'TOEIC ' +
                                data[0]['utoeic'].toString() +
                                '   IELTS ' +
                                data[0]['uielts'].toString() +
                                '   TOEFL ' +
                                data[0]['utoefl'].toString(),
